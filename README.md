...
| ------------- | ------------- | ----- |
| [Social network](https://github.com/dmitryabov/network) | Социальная сеть, в которой можно авторизоваться, написать пост, редактировать профиль, редактировать статус | React, Redux, Jest, Enzyme, Webpack |
